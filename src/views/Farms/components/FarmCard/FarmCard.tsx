...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethereum, account }) => {
  ...
  // We assume the token name is coin pair + lp e.g. CAKE-KLAY LP, LINK-KLAY LP,
    ...
    <FCard>
      ...
      <ExpandingWrapper expanded={showExpandableSection}>
        <DetailsSection
          ...
          bscScanAddress={
            farm.isTokenOnly ?
              `https://scope.klaytn.com/token/${farm.tokenAddresses[process.env.REACT_APP_CHAIN_ID]}`
              :
              `https://scope.klaytn.com/token/${farm.lpAddresses[process.env.REACT_APP_CHAIN_ID]}`
          }
