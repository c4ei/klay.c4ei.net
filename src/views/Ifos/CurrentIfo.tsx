    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy CAKE and KLAY tokens')}</li>
            <li>{TranslateString(598, 'Get CAKE-KLAY LP tokens by adding CAKE and KLAY liquidity')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://swap.c4ei.net/#/swap" mr="16px">
              {TranslateString(999, 'Buy cake')}
            </LinkExternal>
            <LinkExternal href="https://swap.c4ei.net/#/add/ETH/0x4A01A7ecE21199b20e4A5B48c3C1D95f95d98788">
