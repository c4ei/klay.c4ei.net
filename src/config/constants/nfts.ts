...
export const RABBIT_MINTING_FARM_ADDRESS = '0x8B2cF921fE7A2cf600F959B840EcBEdBA13F24A8'
export const PANCAKE_RABBITS_ADDRESS = '0xab69B8dB6A4D197EAe8CdDF2e32E816DE7AfeB49'

const Nfts: Nft[] = [
  {
    name: 'klay',
    description: 'These bunnies love nothing more than swapping KLAY.',
    originalImage: 'https://ipfs.io/ipfs/QmPEAdVXrge7jzccmAEPE4JgvezEtUfKx97ej1uCu7CUdc?filename=8217.png',
    previewImage: 'klay.png',
    blurImage: 'klay.png',
    sortOrder: 999,
    bunnyId: 0,
  },
