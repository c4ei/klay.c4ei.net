...
const ifos: Ifo[] = [
  {
    ...
    description:
      'BLINk enables KLAY holders to enjoy gaming experiences that WINk users on Tron have been enjoying for over two years.',
    launchDate: 'Nov. 20',
    launchTime: '9PM SGT',
    ...
    currency: 'CAKE-KLAY LP',
    currencyAddress: '0xdF9f91651fb6530e34B9c7A594c7FcD5F77c00e0',
    tokenDecimals: 6,
  ...
  },
  {
    ...
    description:
      'Ditto is the first elastic supply token on the KLAY. Its goal is to maintain a stable price of $1, where its supply will adapt to changes in demand. All supply changes will apply equally to every wallet holding Ditto, and holders should always have the same % of the total supply',
    launchDate: 'Dec. 23',
    launchTime: '3PM SGT',
  ...
  },
  {
    ...
    isActive: true,
    name: 'Soteria',
    subTitle: 'A blockchain based mutual to share the risk of DeFi on KLAY',
    description:
