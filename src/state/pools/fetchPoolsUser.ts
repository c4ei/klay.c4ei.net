...
// KLAY pools use the native KLAY token (wrapping ? unwrapping is done at the contract level)
...
export const fetchUserPendingRewards = async (account) => {
  ...
  // Cake / Cake pool
  const pendingReward = await masterChefContract.methods.pendingSawon('0', account).call()
